...
CFLAGS		+=	$(shell $(PKGCONF_MAC) --cflags SDL2_image SDL2_ttf sdl2)
CXXFLAGS	+=	$(shell $(PKGCONF_MAC) --cflags SDL2_image SDL2_ttf sdl2)
LDFLAGS		+=	$(shell $(PKGCONF_MAC) --libs SDL2_image SDL2_ttf sdl2) \
				$(shell $(PKGMAC) --libs harfbuzz freetype2)

# Source file
SRC = sdlmain.c sdltriangle.c sdlanimate.c
